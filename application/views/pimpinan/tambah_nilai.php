                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <?php if ($this->session->userdata('bos2') == 1) { ?>
                                <form class="m-t" role="form" action="<?php echo site_url('nilai_realisasi_pimpinan/tambah_nilai_pimpinan_form2/'.$id_karyawan.'/'.$nama_karyawan); ?>" method="post">
                            <?php } else { ?>
                                <form class="m-t" role="form" action="<?php echo site_url('nilai_realisasi_pimpinan/tambah_nilai_form/'.$id_karyawan); ?>" method="post">
                            <?php } ?>
                            ...
                            <!-- Input Bulan Diletakkan di Bawah -->
                        ...
                        <?php } else { 
                            echo '<div class="alert alert-info text-center">Nilai Realisasi Bulan Ini Sudah Diinputkan! Silahkan Update Untuk Memperbarui.</div>'; 
                        } ?>
                        </div>
                        </div>
                    </div>
