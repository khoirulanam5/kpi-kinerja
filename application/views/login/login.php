...
<body class="gray-bg">
    ...
    <div class="container">
        ...
        <div class="col-md-8">
            <br><br><br><br>
            <img src="<?php echo base_url('assets/img/open.jpg')?>" alt="Login Image" class="img-fluid" style="width: 700px; height: 500px;">
        </div>
        <div class="row">
            <!-- Form Login - Kiri -->
            <div class="col-md-4">
                <div class="middle-box text-center loginscreen animated fadeInDown" style="padding-top: 60px;">
                    ...
                    <div class="ibox-content">
                      ...
                      <form class="m-t" role="form" action="<?php echo site_url('login'); ?>" method="post">
                        ...
                        <div class="switch-container">
                            ...
                            <div class="switch-label" id="pimpinanLabel">Penilai</div>
                        </div><br><br>
