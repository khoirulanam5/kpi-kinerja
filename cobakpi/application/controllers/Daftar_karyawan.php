...
class Daftar_karyawan extends CI_Controller {
	...
	public function edit_karyawan_form($id_users) {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->session->set_flashdata('hasil', '<div class="alert alert-danger text-center">Data tidak valid, periksa kembali inputan Anda!</div>');
			redirect('edit_karyawan/' . $id_users);
		} else {
			$user = [
